...
export default function OrderForm({ cartItems, onOrderSuccess }) {
  ...
  const calculateTotal = () => {
    ...
    // In your OrderForm component, update the handleSubmit function:
    const handleSubmit = async (e) => {
    e.preventDefault();
    setIsSubmitting(true);

    // Basic validation
    if (!formData.customer.name || !formData.customer.phone || !formData.customer.address || !formData.customer.city) {
    ...
    try {
        const orderData = {
            ...
            whatsappConfirmed: formData.whatsappConfirmed, // This will be ignored by API (set to false)
            customerWhatsappConfirmed: formData.whatsappConfirmed, // This is what matters for customer confirmation
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Label htmlFor="customer.name">Nom Complet <span className='text-red-700'>*</span></Label>
            <Input
                id="customer.name"
                name="customer.name"
            ...
            <div className="space-y-2">
            <Label htmlFor="customer.phone">Numéro de Téléphone <span className='text-red-700'>*</span></Label>
            <Input
                id="customer.phone"
                name="customer.phone"
                type="tel"
            ...
            <div className="space-y-2">
            <Label htmlFor="customer.city">Ville<span className='text-red-700'>*</span></Label>
            <Input
                id="customer.city"
                name="customer.city"
            ...
            <div className="space-y-2">
            <Label htmlFor="customer.address">Adresse Complète <span className='text-red-700'>*</span></Label>
            <Input
                id="customer.address"
